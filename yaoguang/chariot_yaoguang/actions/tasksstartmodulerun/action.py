import chariot
from .schema import TasksstartmodulerunInput, TasksstartmodulerunOutput, Input, Output, Component
# Custom imports below


class Tasksstartmodulerun(chariot.Action):

    def __init__(self):
        super(self.__class__, self).__init__(
                name='tasksstartmodulerun',
                description=Component.DESCRIPTION,
                input=TasksstartmodulerunInput(),
                output=TasksstartmodulerunOutput())
    ...
    def run(self, params={}):
        ...
        api = "/rest_api/v3/tasks/start_module_run"
